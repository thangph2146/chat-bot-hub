    ...
    <header className="w-full p-3 sm:p-4 shadow-lg flex justify-between items-center sticky top-0 z-50">
      <div className="flex items-center">
        ...
        <button 
          ...
          className="md:hidden mr-3 p-1.5 rounded-md hover:bg-primary-800 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 active:bg-primary-600"
      ...
      {userInfo && (
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button 
            ...
            className="bg-red-700 hover:bg-red-800 text-white font-medium py-1.5 px-3 sm:px-4 rounded-full transition-all duration-200 transform hover:scale-105 hover:shadow-md flex items-center text-xs sm:text-sm"
          >
